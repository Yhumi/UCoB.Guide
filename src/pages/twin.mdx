...
- Add images to break up large blocks of text
- Change tank uptime example placeholder links to clips
...
<div class="grid max-w-full place-content-center mt-6">
    <Image src={twister} alt="A Twister" class="rounded-md"/>
</div>
...
the <BuffDebuff name="Neurolink" img={neurolink} /> debuff on intercept, the orb will further explode, dealing
